...
public class Titulos {
   ...
   // Título del Juego más una breve descripción.
    ...
    public static void tituloResumenPartida(){
        int margen = 40;
        System.out.println(Utilidades.ANSI_PURPLE+  " ".repeat(margen) + "  ____  _____ ____  _   _ __  __ _____ _   _   ____  _____   ____   _    ____ _____ ___ ____    _    ____  \r\n" + //
                                                    " ".repeat(margen) +" |  _ \\| ____/ ___|| | | |  \\/  | ____| \\ | | |  _ \\| ____| |  _ \\ / \\  |  _ \\_   _|_ _|  _ \\  / \\  / ___| \r\n" + //
                                                    " ".repeat(margen) +" | |_) |  _| \\___ \\| | | | |\\/| |  _| |  \\| | | | | |  _|   | |_) / _ \\ | |_) || |  | || | | |/ _ \\ \\___ \\ \r\n" + //
                                                    " ".repeat(margen) +" |  _ <| |___ ___) | |_| | |  | | |___| |\\  | | |_| | |___  |  __/ ___ \\|  _ < | |  | || |_| / ___ \\ ___) |\r\n" + //
                                                    " ".repeat(margen) +" |_| \\_\\_____|____/ \\___/|_|  |_|_____|_| \\_| |____/|_____| |_| /_/   \\_\\_| \\_\\|_| |___|____/_/   \\_\\____/ \r\n" + //
                                                    " ".repeat(margen) +"                                                                                                           "+Utilidades.ANSI_RESET);
    }
}
