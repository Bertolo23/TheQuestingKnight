...
public class Titulos {
     ...
     */
     ...
     public static void imprimirCuadroTexto(String[] texto) {
        ...
        System.out.println(" ".repeat(margen)+ ANSI_BOLD+"╔" + "═".repeat(ancho + 2) + "╗"); // Imprimir la parte superior del cuadro

        for (String linea : texto) {
            System.out.println(" ".repeat(margen) +"║ " + linea + " ".repeat(ancho - linea.length()) + " ║");  // Imprimir el texto dentro del cuadro
        }

        System.out.println(" ".repeat(margen) +"╚" + "═".repeat(ancho + 2) + "╝"+ANSI_RESET);  // Imprimir la parte inferior del cuadro
    }
    ...
    public static void imprimirCuadroTextoInicial(String[] texto) {
        ...
        System.out.println(" ".repeat(margen) +ANSI_YELLOW+"╔" + "═".repeat(ancho + 2) + "╗"); // Imprimir la parte superior del cuadro
