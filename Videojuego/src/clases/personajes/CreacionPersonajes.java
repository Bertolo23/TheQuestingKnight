...
public class CreacionPersonajes {
    ...
    public static final double SALUD = 10;
    ...
    public static final int ENEMIGO_FATIGA= 0;
    ...
    // Constantes para Enemigo1
     ...
     public static Enemigo enemigo1 = new Enemigo(ENEMIGO1_NOMBRE, ENEMIGO1_VITALIDAD, ENEMIGO1_FUERZA, ENEMIGO1_AGILIDAD, ENEMIGO1_SALUD, ENEMIGO1_NIVEL, ENEMIGO1_TIPO, ENEMIGO_FATIGA);
     public static Enemigo enemigo2 = new Enemigo(ENEMIGO2_NOMBRE, ENEMIGO2_VITALIDAD, ENEMIGO2_FUERZA, ENEMIGO2_AGILIDAD, ENEMIGO2_SALUD, ENEMIGO2_NIVEL, ENEMIGO2_TIPO, ENEMIGO_FATIGA);
     public static Enemigo enemigo3 = new Enemigo(ENEMIGO3_NOMBRE, ENEMIGO3_VITALIDAD, ENEMIGO3_FUERZA, ENEMIGO3_AGILIDAD, ENEMIGO3_SALUD, ENEMIGO3_NIVEL, ENEMIGO3_TIPO, ENEMIGO_FATIGA);
     public static Enemigo enemigo4 = new Enemigo(ENEMIGO4_NOMBRE, ENEMIGO4_VITALIDAD, ENEMIGO4_FUERZA, ENEMIGO4_AGILIDAD, ENEMIGO4_SALUD, ENEMIGO4_NIVEL, ENEMIGO4_TIPO, ENEMIGO_FATIGA);
}
