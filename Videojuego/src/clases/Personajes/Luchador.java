...
public class Luchador extends Personaje {
    ...
    public void introduccionPersonaje() {
        ...
        System.out.println(Utilidades.ANSI_GREEN + " ".repeat(margen - 2) + "     ║ VITALIDAD ║" + Utilidades.ANSI_RED + "║ FUERZA ║" + Utilidades.ANSI_YELLOW + "║ AGILIDAD ║" + Utilidades.ANSI_BLUE + "║ PERCEPCIÓN MÁGICA ║"+Utilidades.ANSI_PURPLE + "║ CORAJE ║" + Utilidades.ANSI_CYAN + "║ SALUD ║");        
